                        ...
                        if 'features' in res and len(res['features']) > 0:
                            ...
                            dane = [
                                ...
                                {"Firma": "Ryba Taxi 🐟", "Btn": "ZADZWOŃ", "Val": ryba_min, "Promo": 0,
                                 "Main": f"{ryba_min:.2f} - {ryba_max:.2f} PLN", "Link": "intent://#Intent;package=pl.itaxi.ryba.client;S.browser_fallback_url=https://play.google.com/store/apps/details?id=pl.itaxi.ryba.client;end", "Vars": []}
                            ]
